...
describe("Email Marketing Router", () => {
  describe("subscribeNewsletter", () => {
    ...
    it("should reject duplicate subscription", async () => {
      await publicCaller.emailMarketing.subscribeNewsletter({
  ...
  describe("unsubscribeNewsletter", () => {
    it("should unsubscribe from newsletter", async () => {
      ...
      const result = await publicCaller.emailMarketing.unsubscribeNewsletter({
        email: "unsub@example.com",
      });
  ...
  describe("getCampaignStats", () => {
    it("should return campaign statistics (admin only)", async () => {
      ...
      await adminCaller.emailMarketing.sendCampaign({
        campaignId: campaign.campaign.id,
      });

      const result = await adminCaller.emailMarketing.getCampaignStats({
        campaignId: campaign.campaign.id,
      });
